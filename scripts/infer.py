...
def main():
    ...
    parser.add_argument("--checkpoint", type=str, default="/home/sty/pyfile/poem2layout5.3.2/outputs/rl_best_reward.pth", help="Path to specific checkpoint (default: auto-find best)")
